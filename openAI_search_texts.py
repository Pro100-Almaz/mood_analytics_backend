...
- В поле comment напиши сам текст и ссылку, в поле opinion напиши отношение этого коммента.
{
  "overall": {
...
tool 4: FB - sentiment analysis tool.
Параметры: array of 8 keyword phrases.
